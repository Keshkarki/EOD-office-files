...
bank_nifty_df = pd.read_csv(f'C:\\keshav\\Rahul\\Options_data\\NIFTY & BANKNIFTY (Jan 2020 to 19 Dec 2022)\\NIFTY & BANKNIFTY Spot Indices (Jan 2020 to 19 Dec 2022)\\{underlying}.csv',header=None)
...
class Straddle:
    ...
    def __init__(self, date, exp_period,
...
print(straddle_instance.rel_CE_df)
