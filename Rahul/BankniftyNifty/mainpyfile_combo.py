    ...
    for i, row in df.iterrows():
        ...
        try:
            ...
            if dt in option_df2.index:
                price_value1 = option_df2.loc[option_df2.index== dt, f'{option_type}close'].values[0]
                df.loc[df.index == dt, f'{option_type}price'] = price_value1
...
def process_option_data_exit(symbol,option_type):
    for i, row in df.iterrows():
        ...
        try:
            ...
            if dt in option_df2.index:
                price_value2 = option_df2.loc[option_df2.index== dt, f'{option_type}close']
                print('hellllll')
                df.loc[df['exitDt'] == dt, f'Exit_{option_type}price'] = price_value2
...
# df.to_csv("C:\\keshav\\Rahul\\BankniftyNifty\\finaldf_filled5.csv")